...
{
    /// <summary>
    /// Переключатель языка интерфейса инструмента (RU/EN).
    /// В Editor хранится в EditorPrefs; в build-сборке игры EditorPrefs нет,
    /// поэтому в рантайме возвращаем дефолтный язык (RU) и Toggle = no-op.
    /// </summary>
