...
namespace NovellaEngine.Editor
{
    public static class NovellaSocialIcons
    {
        ...
        // ─── Telegram ──────────────────────────────────────────────────
        // Голубой круг + белый бумажный самолётик, ориентированный
        // вправо-вверх (фирменный приём логотипа).
        private static Texture2D BuildTelegram()
        {
            var t = MakeTex();
            // Закрашенный круг.
            FillCircle(t, 32, 32, 30, TelegramBlue);

            // Бумажный самолётик из двух треугольников.
            // Координаты подобраны вручную чтобы силуэт читался узнаваемо.
            // Y перевёрнут (Texture2D имеет Y снизу).
            // 1) большой план самолётика
            FillTriangle(t,
                new Vector2(15, 40),  // нос-левый-нижний
                new Vector2(50, 53),  // правый-верхний (нос)
                new Vector2(28, 28),  // хвост-внизу
                Color.white);
            // 2) фасадный/нижний треугольник — «сложение» крыла
            FillTriangle(t,
                new Vector2(28, 28),
                new Vector2(50, 53),
                new Vector2(36, 22),
