...
namespace NovellaEngine.Editor.Tutorials
{
    ...
    public class NovellaTutorialStep
    {
        ...
        [Tooltip("Можно ли закрыть туториал кнопкой Close (✕) с этого шага. " +
                 "Закрытие НЕ помечает урок пройденным — прогресс не двигается. " +
                 "Используйте false если шаг критичен и нельзя бросить на середине.")]
